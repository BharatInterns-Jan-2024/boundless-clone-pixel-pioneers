...
var Star = function(x, y, maxSpeed) {
  ...
  var StarField = function(containerId) {
    ...
    this.canvasElem.style.background = 'transparent';
    this.canvasElem.style.zIndex = '1'; // Ensure it's on top
  };
  ...
  StarField.prototype._renderStarField = function() {
    ...
    this.canvas.clearRect(0, 0, this.width, this.height);
    // Background
    // this.canvas.fillStyle = "rgba(0, 0, 0, .8)";
  ...
  // Kick off!
  var starField = new StarField('fullScreen').render(50, 8);
